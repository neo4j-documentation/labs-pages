...
== Documentation
For installing, configuring and extending the starter kit, check out the link:https://neo4j.com/labs/neo4j-needle-starterkit/2.1/[Documentation].
...
| icon:book[] Documentation | https://neo4j.com/labs/neo4j-needle-starterkit/2.1/
// | icon:book[] Article |
