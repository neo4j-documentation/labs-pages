...
[WARNING]
====
Halin features have been graduated to https://neo4j.com/docs/ops-manager/current/[Neo4j Operations Manager] and the labs project has been discontinued. 
Please move your usage of Halin to Neo4j Ops Manager instead.
====
