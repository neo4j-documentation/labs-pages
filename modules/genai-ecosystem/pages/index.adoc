...
3. Integrate one of the https://neo4j.com/developer/genai-ecosystem/model-context-protocol-mcp/#neo4j[Neo4j MCP servers^] into your AI assistant or development workflow.
4. If you want to learn more take one of the https://graphacademy.neo4j.com/categories/llms/?ref=genai-docs[GenAI GraphAcademy courses^]
5. Pick your xref:genai-frameworks.adoc[GenAI framework of choice] and start building your own GenAI applications with Neo4j
...
* https://neo4j.com/developer/genai-ecosystem/model-context-protocol-mcp/[Labs MCP Servers^]
...
* xref:strands-agents-neo4j.adoc[Strands Agents]
* xref:ms-agent-framework.adoc[MS Agent Framework]
* xref:mcp-toolbox.adoc[MCP Toolbox]
// * xref:dspy.adoc[DSPy]

=== Agent Frameworks

Agent frameworks give developers the building blocks to connect language models to tools, memory, and external data sources like Neo4j. Agents can reason over multiple steps, choose which tools to invoke, and adapt their behaviour based on intermediate results.
...
Agent platforms are managed, enterprise-grade environments for deploying and operating AI agents at scale. They provide hosted runtimes, observability, governance, and marketplace integrations, with Neo4j available as a knowledge tool through MCP or REST.
