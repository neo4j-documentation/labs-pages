...
3. Integrate one of the https://neo4j.com/developer/genai-ecosystem/model-context-protocol-mcp/[Neo4j Labs MCP^] servers into your AI assistant or development workflow.
