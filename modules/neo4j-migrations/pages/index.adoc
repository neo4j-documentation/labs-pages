...
:neo4j-versions: 3.5, 4.0, 4.1, 4.2, 4.3, 4.4, Aura, 5.x, 2025.x
...
Neo4j-Migrations builds directly on top of the official Neo4j-Java-Driver, supports Neo4j 3.5, Neo4j 4.1 to 4.4, Neo4j 5, and Neo4j 2025.x, including enterprise features such as multidatabase support and impersonation.
