...
=== https://neo4j.sh[Neo4j-cli]

https://neo4j.sh[Neo4j-cli] is  new modern and fast super CLI for humans and coding agents with consistent structure, efficient-output and self documenting capabilities and skills. 
It allows to manage databases locally and remotely, query your database, compute embeddings as parameters and much more. Built with AI for AI.
...
NeoDash is a low-code Dashboard Builder for Neo4j. It lets you build an interactive dashboard with tables, graphs, bar charts, line charts, maps and more. NeoDash has graduated into Neo4j Dashboards, which is now part of Neo4j Desktop, the Aura Console, and Enterprise Studio.
